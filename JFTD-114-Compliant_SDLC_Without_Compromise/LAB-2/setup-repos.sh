...
create-remote-repos(){
    ...
    reposData="[ { \"key\": \"jftd114-lab2-mvn-remote\", \"packageType\": \"maven\", \"rclass\": \"remote\", \"url\": \"https://repo1.maven.org/maven2/\", \"xrayIndex\": true} ]"
...
create-local-repos(){
    ...
    reposData="[ {\"key\": \"jftd114-lab2-mvn-local\", \"packageType\": \"maven\", \"rclass\": \"local\", \"xrayIndex\": true }  ]"
...
create-virtual-repos(){
    ...
    reposData="[ { \"key\": \"jftd114-lab2-mvn-virtual\", \"packageType\": \"maven\", \"rclass\": \"virtual\", \"description\": \"The virtual repository public description\", \"defaultDeploymentRepo\": \"jftd114-lab2-mvn-local\", \"repositories\": [ \"jftd114-lab2-mvn-local\", \"jftd114-lab2-mvn-remote\"], \"xrayIndex\": true }]"
