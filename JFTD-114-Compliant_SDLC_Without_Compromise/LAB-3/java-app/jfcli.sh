...
export JF_HOST="academy-artifactory" JFROG_RT_USER="admin" JFROG_CLI_LOG_LEVEL="INFO" # JF_ACCESS_TOKEN="<GET_YOUR_OWN_KEY>"
...
echo "{ \"files\": [ {\"build\": \"${BUILD_NAME}/${BUILD_ID}\", \"includeDeps\": \"false\", \"props\": \"\" } ] }" >$VAR_RBv2_SPEC_JSON
